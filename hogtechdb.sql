-- Extensions are managed via Supabase dashboard; ensure the required ones are enabled there:
-- pg_cron, pg_graphql, pg_stat_statements, pgcrypto, supabase_vault, uuid-ossp
